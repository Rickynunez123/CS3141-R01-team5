    ...
    <body>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
	        ...
	        if ($mysqli -> connect_errno) {
                ...
                //Delete all password reset requests that have timed out
                $sqlCMD = "DELETE FROM OTP WHERE type=1 AND timeout < now() - interval 1 hour";
                $mysqli->query($sqlCMD);
                ...
                if(isset($result[0]) && $result[1] == 1) {
                    ...
                    echo "<script>alert('Password Reset Token is Expired or Invalid!'); window.location.href='login.php'; </script>";
                }
	        }
        }
        ?>
